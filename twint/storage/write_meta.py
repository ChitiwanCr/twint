def tweetData(t):
    data = {
            ...
            "post_follower": int(t.post_follower),
            "post_profile_image": t.post_profile_image,
            "hashtags": t.hashtags,
            "cashtags": t.cashtags,
            "link": t.link,
            "retweet": t.retweet,
            ...
            "retweet_follower":t.retweet_follower,
            "retweet_profile_image":t.retweet_profile_image,
            "reply_to": t.reply_to,
